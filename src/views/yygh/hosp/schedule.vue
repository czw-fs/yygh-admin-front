...
export default {
    ...
    methods:{
        ...
        fetchData() {
            hospApi.getDepartmentList(this.hoscode)
                .then(response => { 
        ...
        getScheduleRule() {
            schedule.getSchedulePage(this.page, this.limit, this.hoscode, this.depcode).then(response => {
